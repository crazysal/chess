#  Makefile "IRgdb.make", by KWR for the "Intrinsic Ratings" project
#  Compiles with Gnu DB info for debugging via gdb
#  USAGE---enter at command prompt in directory:  make -f IRgdb.make


# Unix Macros---choose which compiler and options here!

CC     = g++ -O0 -g     #optional change to: g++ -Wall
...
IR: IRmain.o Demos.o Ensemble.o Minimizer.o Trial.o PerfData.o 
	$(CC) $(FLAGS) -o IRdb IRmain.o Demos.o Ensemble.o Minimizer.o Trial.o PerfData.o $(LIBS)
